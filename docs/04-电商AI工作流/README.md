...
| 9 | [MiniMax H3 本地模型：有限配置工作流](09-MiniMax-H3本地模型有限配置工作流.md) | Ref2VA 本地权重、24 GB 实验配置、4 步低负载竖屏商品视频与逐节点说明 | [打开](workflows/ecommerce-minimax-h3-local-ref2va.json) |
...
| 7 | 商品广告与带货视频 | MiniMax H3 本地 Ref2VA 最小链路已搭建，待 24 GB+ GPU 实测 | 商品一致性、镜头设计、显存与多素材引用 |
