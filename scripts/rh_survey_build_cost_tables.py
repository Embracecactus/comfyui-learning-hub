...
MM_CN = "platform.minimax.cn/docs/guides/pricing-paygo(官方原厂价)"
MM_USD = "platform.minimax.io/docs/guides/pricing-paygo(官方原厂价)"
...
UNVERIFIED_STD = ("RunningHub 平台侧价格未公开(官方定价文件无 H3 条目, "
                  "price-preview 需企业级-共享 Key);按原厂每秒价推算, 平台加价/折扣未知")


def mm_row(endpoint, mode, pixels, note="", audio="原生带音轨, 不另收费(MiniMax 官方: 音频输入免费)"):
...
rows_768p = [
    ...
    ["minimax/hailuo-h3-max/text-to-video", "标准模型 API·仅企业级-共享 Key", "CN",
     ...
     "¥2.50", "¥5.00", "¥7.50", "¥0.50", "CNY", "推算(官方原厂锚点)", MM_CN,
    ...
    ["minimax/hailuo-h3/text-to-video(768P 档)", "AI 应用 API·个人消费 Key 可用(官方应用按实际用量计费)",
     ...
     "推算(以 2K 实测结构外推, 见 2K 表第 1 行)", "锚点 " + MM_CN + ";币值缺口未定",
...
rows_2k = [
    ["minimax/hailuo-h3/text-to-video(2K 档)", "AI 应用 API·个人消费 Key 可用(官方应用 2083105376052006914)",
     ...
     "10/15s 未实测;币→元未定;¥0.77/s 与 MiniMax 标价 ¥0.80/s 差 3.7%(渠道折扣或汇率, 保留冲突证据)"],
    ["minimax/hailuo-h3/text-to-video(2K 档)", "标准模型 API·仅企业级-共享 Key", "CN",
     ...
     "¥4.00", "¥8.00", "¥12.00", "¥0.80", "CNY", "推算(官方原厂锚点)", MM_CN,
    ...
    ["minimax/hailuo-h3/image-to-video(2K 档)", "标准模型 API·仅企业级-共享 Key", "CN",
     ...
     "¥4.00", "¥8.00", "¥12.00", "¥0.80", "CNY", "推算(官方原厂锚点: t2v/i2v 同价)",
    ...
    ["minimax/hailuo-h3 两阶段 768P→2K(官方 regeneration 路线, 情形 C)",
     ...
     "推算(官方原厂锚点;两阶段合计)", MM_CN + ";端点契约 " + "runninghub.ai api-498427804",
     "2026-09-13", "schema_verified(未实测)",
    ...
    ["minimax/hailuo-h3 768P → rhart-video/video-upscaler(targetResolution=2k)",
     ...
     "阶段1: 768P ¥0.50/秒(锚点);阶段2: 超分 ¥0.35/秒(官方标价)",
     "¥4.25", "¥8.50", "¥12.75", "¥0.85", "CNY",
     "推算(混合口径: 原厂锚点+官方标价)", KIT_SNAPSHOT + " + " + MM_CN,
